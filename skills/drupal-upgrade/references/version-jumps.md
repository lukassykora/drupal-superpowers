...
|---|---|---|---|---|---|---|
| 9.x → 10.x | 9.4+ recommended; deprecations fixed on 9.5 | 8.1+ | MySQL 5.7.8 / MariaDB 10.3.7 / PgSQL 10 | 6.x | 11/12 | CKEditor 4 → 5, Classy/Stable/Seven/Bartik removed (contrib), jQuery UI removed, Quick Edit/RDF/Aggregator/HAL/Tracker removed (contrib) |
...
| 11.x minors | previous minor | 11.3+: 8.3–8.5 | | 7.x | 13 (14 for 11.3+) | 11.4 deprecates Contact, Field Layout, History, Migrate Drupal (+UI), Telephone, Stable 9; Standard profile no longer ships Article/Page |
